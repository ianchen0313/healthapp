...
# app section
st.title('成功逆轉腎 :point_up:')
st.warning('為達到較佳的使用體驗，手機用戶請使用瀏覽器開啟此網頁，如：chrome, safari 等，請勿使用社群平台內建之瀏覽器開啟')
...
with st.expander("查看更多關於模型表現"):
    st.text("""
            ...
            Accuracy(整體預測正確率): [0.7222, 0.7306]
            Sensitivity(實際有病者中預測為有病比率): [0.6222, 0.6667]
            Specificity(實際沒病者中預測為沒病比率): [0.7257, 0.7343]
            """)
